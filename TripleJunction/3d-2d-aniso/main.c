                    ...
                    for (n2 = 1; n2 <= phiNum[i][j][l]; n2++)
                    {
                        ...
                        for (n3 = 1; n3 <= phiNum[i][j][l]; n3++)
                        {
                            ...
                            if (anij[ii][kk] == 1 && (phidx * phidx + phidy * phidy != 0.0))
                            {
                                ...
                                termiikk = term0 + termx0 + termx1 + termy0 + termy1;
                            }
                            else
                            {
                                epsilon0 = sqrt(aij[ii][kk]);
                            ...
                            if (anij[jj][kk] == 1 && (phidx * phidx + phidy * phidy != 0.0))
                            {
                                ...
                                theta = calcTheta(phidy, phidx) - thij[jj][kk]; //界面の法線方向の角度[式(4.24)]
                                vphi = calcVphi(phidx, phidy, phidz) - vphij[jj][kk];
                                ...
                                termjjkk = term0 + termx0 + termx1 + termy0 + termy1;
                            }
                            else
                            {
                                epsilon0 = sqrt(aij[jj][kk]);
